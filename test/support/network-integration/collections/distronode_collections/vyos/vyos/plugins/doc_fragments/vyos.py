...
class ModuleDocFragment(object):
  ...
  provider:
    description:
    - B(Deprecated)
    - 'Starting with Distronode 2.5 we recommend using C(connection: network_cli).'
    ...
    suboptions:
      ...
      username:
        ...
        - Configures the username to use to authenticate the connection to the remote
          ...
          is not specified in the task, the value of environment variable C(DISTRONODE_NET_USERNAME)
      ...
      password:
        ...
        - Specifies the password to use to authenticate the connection to the remote
          device.   This value is used to authenticate the SSH session. If the value
          is not specified in the task, the value of environment variable C(DISTRONODE_NET_PASSWORD)
          will be used instead.
        type: str
      timeout:
        description:
      ...
      ssh_keyfile:
        ...
        - Specifies the SSH key to use to authenticate the connection to the remote
          ...
          variable C(DISTRONODE_NET_SSH_KEYFILE) will be used instead.
        type: path
notes:
