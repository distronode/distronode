...
from distronode.parsing.vault import VaultLib, VaultEditor, match_encrypt_secret

from distronode.module_utils.common.text.converters import to_bytes, to_text

from units.mock.vault_helper import TextVaultSecret

v11_data = """$DISTRONODE_VAULT;1.1;AES256
...
class TestVaultEditor(unittest.TestCase):
    ...
    def _create_test_dir(self):
        suffix = '_distronode_unit_test_%s_' % (self.__class__.__name__)
    ...
    @patch('distronode.parsing.vault.subprocess.call')
    ...
    def test_edit_file_helper_call_exception(self, mock_sp_call):
        ...
        mock_sp_call.side_effect = errors.DistronodeError(error_txt)
    ...
    def test_edit_file_no_vault_id(self, mock_sp_call):
        ...
        self.assertTrue(b'$DISTRONODE_VAULT;1.1;AES256' in new_src_file_contents)
    ...
    def test_edit_file_with_vault_id(self, mock_sp_call):
        ...
        self.assertTrue(b'$DISTRONODE_VAULT;1.2;AES256;vault_secrets' in new_src_file_contents)
    ...
    def test_create_file(self, mock_editor_shell_command):
        ...
        _secrets = self._secrets('distronode')
    ...
    def test_decrypt_1_1(self):
        ...
        ve = self._vault_editor(self._secrets("distronode"))
