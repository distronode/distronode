...
from distronode.plugins.lookup.ini import _parse_params
...
class TestINILookup(unittest.TestCase):
    ...
    old_style_params_data = (
        ...
        dict(
            term=u'keyC section=sectionC file=/path/with/equals/cn=com.distronode',
            expected=[u'file=/path/with/equals/cn=com.distronode', u'keyC', u'section=sectionC'],
        ),
        dict(
            term=u'keyD section=sectionD file=/path/with space and/equals/cn=com.distronode',
            expected=[u'file=/path/with space and/equals/cn=com.distronode', u'keyD', u'section=sectionD'],
        ),
        dict(
