...
from distronode.plugins.loader import PluginLoader
...
class TestInventoryModule(unittest.TestCase):
    ...
    def setUp(self):
        ...
        inv_loader = PluginLoader('InventoryModule', 'distronode.plugins.inventory', C.DEFAULT_INVENTORY_PLUGIN_PATH, 'inventory_plugins')
        ...
        self.BaseInventoryPlugin = register_patch('distronode.plugins.inventory.BaseInventoryPlugin')
    ...
    def test_parse_subprocess_path_not_found_fail(self):
        ...
        with pytest.raises(DistronodeError) as e:
