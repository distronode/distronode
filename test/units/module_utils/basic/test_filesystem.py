...
class TestOtherFilesystem(ModuleTestCase):
    def test_module_utils_basic_distronode_module_user_and_group(self):
        from distronode.module_utils import basic
        basic._DISTRONODE_ARGS = None

        am = basic.DistronodeModule(
            argument_spec=dict(),
        )
    ...
    def test_module_utils_basic_distronode_module_find_mount_point(self):
        from distronode.module_utils import basic
        basic._DISTRONODE_ARGS = None
    ...
    def test_module_utils_basic_distronode_module_set_owner_if_different(self):
        from distronode.module_utils import basic
        basic._DISTRONODE_ARGS = None
    ...
    def test_module_utils_basic_distronode_module_set_group_if_different(self):
        from distronode.module_utils import basic
        basic._DISTRONODE_ARGS = None
    ...
    def test_module_utils_basic_distronode_module_set_directory_attributes_if_different(self):
        from distronode.module_utils import basic
        basic._DISTRONODE_ARGS = None
