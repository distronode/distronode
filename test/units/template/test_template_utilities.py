...
from distronode.template import DistronodeUndefined, _escape_backslashes, _count_newlines_from_end
...
class TestDistronodeUndefined(unittest.TestCase):
    def test_getattr(self):
        val = DistronodeUndefined()
