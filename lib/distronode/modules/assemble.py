...
- Often a particular program will take a single configuration file and does not support a
  ...
  from multiple sources. M(distronode.builtin.assemble) will take a directory of files that can be
...
- module: distronode.builtin.template
- module: distronode.windows.win_copy
author:
...
from distronode.module_utils.six import b, indexbytes
