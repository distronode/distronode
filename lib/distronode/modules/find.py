...
description:
    ...
    - For Windows targets, use the M(distronode.windows.win_find) module instead.
...
options:
    ...
    file_type:
        description:
            ...
            - The 'link' and 'any' choices were added in Distronode 2.3.
        type: str
...
attributes:
    ...
    platform:
        platforms: posix
seealso:
- module: distronode.windows.win_find
'''
