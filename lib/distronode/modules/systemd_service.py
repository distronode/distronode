...
description:
    ...
    - M(distronode.builtin.systemd) is renamed to M(distronode.builtin.systemd_service) to better reflect the scope of the module.
      M(distronode.builtin.systemd) is kept as an alias for backward compatibility.
options:
    name:
        description:
    ...
    scope:
        description:
            ...
            - "The user dbus process is normally started during normal login, but not during the run of Distronode tasks.
    ...
    no_block:
        description:
            - Do not synchronously wait for the requested operation to finish.
              Enqueued job will continue without Distronode blocking on its completion.
        type: bool
        default: no
        version_added: "2.3"
...
- name: Make sure a service unit is running
  distronode.builtin.systemd_service:
    state: started
    name: httpd
...
from distronode.module_utils.facts.system.chroot import is_chroot
from distronode.module_utils.service import sysv_exists, sysv_is_enabled, fail_if_missing
...
def parse_systemctl_show(lines):
    ...
    # part of that value. Cryptically, this would lead to Distronode reporting that the service file
    # couldn't be found.
    #
...
def main():
    ...
    if unit:
        ...
        # Workaround for https://github.com/distronode/distronode/issues/71528
