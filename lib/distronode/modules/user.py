...
description:
    ...
    - For Windows targets, use the M(distronode.windows.win_user) module instead.
options:
    name:
        description:
    ...
    groups:
        description:
            ...
            - Before Distronode 2.3, the only input format allowed was a comma separated string.
        type: list
        elements: str
    append:
        description:
    ...
    shell:
        description:
            ...
            - On macOS, before Distronode 2.5, the default shell for non-system users was V(/usr/bin/false).
              Since Distronode 2.5, the default shell for non-system users on macOS is V(/bin/bash).
    ...
    create_home:
        description:
            ...
            - Changed from O(createhome) to O(create_home) in Distronode 2.5.
        type: bool
        default: yes
        aliases: [ createhome ]
    move_home:
    ...
    ssh_key_comment:
        ...
        type: str
        default: distronode-generated on $HOSTNAME
        version_added: "0.9"
    ssh_key_passphrase:
        description:
    ...
    expires:
        description:
            ...
            - Since Distronode 2.6 you can remove the expiry time by specifying a negative value.
...
notes:
  - There are specific requirements per platform on user management utilities. However
    they generally come pre-installed with the system and Distronode will require they
...
seealso:
- module: distronode.posix.authorized_key
- module: distronode.builtin.group
- module: distronode.windows.win_user
author:
...
- name: Starting at Distronode 2.6, modify user, remove expiry time
  distronode.builtin.user:
    name: james18
    expires: -1
...
ssh_fingerprint:
  ...
  type: str
  sample: '2048 SHA256:aYNHYcyVm87Igh0IMEDMbvW0QDlRQfE0aJugp684ko8 distronode-generated on host (RSA)'
ssh_key_file:
...
ssh_public_key:
  ...
  sample: >
    ...
    d5u1u0e6Acju/8aZ/l17IDFiLke5IzlqIMRTEbDwLNeO84YQKWTm9fODHzhYe0yvxqLiK07 distronode-generated on host'
stderr:
...
class User(object):
    ...
    def __init__(self, module):
        ...
        if self.groups is None and self.append:
            ...
            module.warn("'append' is set, but no 'groups' are specified. Use 'groups' for appending new groups."
                        "This will change to an error in Distronode 2.14.")
    ...
    def execute_command(self, cmd, use_unsafe_shell=False, data=None, obey_checkmode=True):
        if self.module.check_mode and obey_checkmode:
            ...
            # cast all args to strings distronode-modules-core/issues/4397
...
def main():
    ssh_defaults = dict(
        ...
        type='rsa',
        passphrase=None,
        comment='distronode-generated on %s' % socket.gethostname()
    )
