...
from distronode.module_utils.common.collections import Mapping, is_sequence
...
def get_ca_certs(cafile=None, capath=None):
    ...
    paths_checked.add('/etc/distronode')
...
class Request:
    def __init__(self, headers=None, use_proxy=True, force=False, timeout=10, validate_certs=True,
        ...
        >>> from distronode.module_utils.urls import Request
        >>> r = Request()
    ...
    def open(self, method, url, data=None, headers=None, use_proxy=None,
        ...
        :returns: HTTPResponse. Added in Distronode 2.9
        """
...
def url_argument_spec():
    ...
    return dict(
        ...
        http_agent=dict(type='str', default='distronode-httpget'),
...
def fetch_url(module, url, data=None, headers=None, method=None,
    ...
    :arg module: The DistronodeModule (used to get username, password etc. (s.b.).
