# (c) 2018 Toshio Kuratomi <tkuratomi@distronode.com>
#
...
if _system_distro:
    ...
    # Our bundled copy
    from distronode.module_utils.distro import _distro as distro

sys.modules['distronode.module_utils.distro'] = distro
