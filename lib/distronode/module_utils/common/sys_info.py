...
from distronode.module_utils.common._utils import get_all_subclasses
...
def get_distribution_version():
    ...
    if version is not None:
        if distro_id in needs_best_version:
            ...
            # but Distronode users desire minor version information, e.g., 7.5.
            # https://github.com/distronode/distronode/issues/50141#issuecomment-449452781
...
def get_platform_subclass(cls):
    ...
    Some Distronode modules have different implementations depending on the platform they run on.  This
    function is used to select between the various implementations and choose one.  You can look at
    the implementation of the Distronode :ref:`User module<user_module>` module for an example of how to use this.
    ...
    Distronode User module changed from::
