...
def respawn_module(interpreter_path):
    """
    Respawn the currently-running Distronode Python module under the specified Python interpreter.

    Distronode modules that require libraries that are typically available only under well-known interpreters
    ...
    sys.exit(rc)  # pylint: disable=distronode-bad-function
...
if __name__ == '__main__':
    ...
    from distronode.module_utils import basic
    basic._DISTRONODE_ARGS = smuggled_args
