...
class NoTokenSentinel(object):
    """ Represents an distronode.cfg server with not token defined (will ignore cmdline and GALAXY_TOKEN_PATH. """
...
class KeycloakToken(object):
    ...
    def get(self):
        ...
        #    - 'refresh_token' is the offline token stored in distronode.cfg
